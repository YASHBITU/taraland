...
export default function VisionEngine({ onClose }: { onClose: () => void }) {
    ...
    const saveScanToSupabase = async (scanData: any) => {
        try {
            ...
            console.log('Saving VisionEngine scan to Supabase...', scanData);
